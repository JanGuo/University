...
class Client(Iface):
    ...
    def recv_getPersonByUserName(self):
        ...
        if result.dataExcpton is not None:
            raise result.dataExcpton
    ...
    def recv_savePerson(self):
        ...
        result.read(iprot)
        iprot.readMessageEnd()
        if result.dataExcption is not None:
            raise result.dataExcption
        return
...
class Processor(Iface, TProcessor):
    ...
    def process_getPersonByUserName(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except DataExcption as dataExcpton:
            msg_type = TMessageType.REPLY
    ...
    def process_savePerson(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except DataExcption as dataExcption:
            msg_type = TMessageType.REPLY
...
class getPersonByUserName_result(object):
    ...
    def __init__(self, success=None, dataExcpton=None,):
        self.success = success
        self.dataExcpton = dataExcpton
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.dataExcpton = DataExcption()
                    self.dataExcpton.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            oprot.writeFieldEnd()
        if self.dataExcpton is not None:
            oprot.writeFieldBegin('dataExcpton', TType.STRUCT, 1)
            self.dataExcpton.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
getPersonByUserName_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'dataExcpton', [DataExcption, None], None, ),  # 1
)
...
class savePerson_result(object):
    ...
    def __init__(self, dataExcption=None,):
        self.dataExcption = dataExcption
    ...
    def write(self, oprot):
        ...
        if self.dataExcption is not None:
            oprot.writeFieldBegin('dataExcption', TType.STRUCT, 1)
            self.dataExcption.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
savePerson_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'dataExcption', [DataExcption, None], None, ),  # 1
)
