...
public class PersonService {
  ...
  public interface Iface {
    ...
    public Person getPersonByUserName(java.lang.String username) throws DataExcption, org.apache.thrift.TException;

    public void savePerson(Person person) throws DataExcption, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUserName() throws DataExcption, org.apache.thrift.TException
    {
      ...
      if (result.dataExcpton != null) {
        throw result.dataExcpton;
      }
    ...
    public void recv_savePerson() throws DataExcption, org.apache.thrift.TException
    {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPersonByUserName<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUserName_args> {
      ...
      public getPersonByUserName_result getResult(I iface, getPersonByUserName_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataExcption dataExcpton) {
          result.dataExcpton = dataExcpton;
        }
        return result;
      }
    }
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            if (e instanceof DataExcption) {
              result.dataExcpton = (DataExcption) e;
              result.setDataExcptonIsSet(true);
              msg = result;
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Void> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Void>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            savePerson_result result = new savePerson_result();
            if (e instanceof DataExcption) {
              result.dataExcption = (DataExcption) e;
  ...
  public static class getPersonByUserName_result implements org.apache.thrift.TBase<getPersonByUserName_result, getPersonByUserName_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUserName_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXCPTON_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExcpton", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataExcption dataExcpton; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      DATA_EXCPTON((short)1, "dataExcpton");
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXCPTON, new org.apache.thrift.meta_data.FieldMetaData("dataExcpton", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getPersonByUserName_result(
      Person success,
      DataExcption dataExcpton)
    {
      this();
      this.success = success;
      this.dataExcpton = dataExcpton;
    }
    ...
    public getPersonByUserName_result(getPersonByUserName_result other) {
      ...
      if (other.isSetDataExcpton()) {
        this.dataExcpton = new DataExcption(other.dataExcpton);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataExcption getDataExcpton() {
      return this.dataExcpton;
    }

    public getPersonByUserName_result setDataExcpton(@org.apache.thrift.annotation.Nullable DataExcption dataExcpton) {
      this.dataExcpton = dataExcpton;
      return this;
    }

    public void unsetDataExcpton() {
      this.dataExcpton = null;
    }

    /** Returns true if field dataExcpton is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExcpton() {
      return this.dataExcpton != null;
    }

    public void setDataExcptonIsSet(boolean value) {
      if (!value) {
        this.dataExcpton = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXCPTON:
        if (value == null) {
          ...
          setDataExcpton((DataExcption)value);
        }
        break;
    ...
    public boolean equals(getPersonByUserName_result that) {
      ...
      boolean this_present_dataExcpton = true && this.isSetDataExcpton();
      boolean that_present_dataExcpton = true && that.isSetDataExcpton();
      if (this_present_dataExcpton || that_present_dataExcpton) {
        if (!(this_present_dataExcpton && that_present_dataExcpton))
          return false;
        if (!this.dataExcpton.equals(that.dataExcpton))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExcpton()) ? 131071 : 524287);
      if (isSetDataExcpton())
        hashCode = hashCode * 8191 + dataExcpton.hashCode();
    ...
    public int compareTo(getPersonByUserName_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataExcpton()).compareTo(other.isSetDataExcpton());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExcpton()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExcpton, other.dataExcpton);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("dataExcpton:");
      if (this.dataExcpton == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExcpton);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getPersonByUserName_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUserName_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUserName_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXCPTON
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExcpton = new DataExcption();
                struct.dataExcpton.read(iprot);
                struct.setDataExcptonIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUserName_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataExcpton != null) {
          oprot.writeFieldBegin(DATA_EXCPTON_FIELD_DESC);
          struct.dataExcpton.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable DataExcption dataExcption; // required
    ...
    public savePerson_result(savePerson_result other) {
      if (other.isSetDataExcption()) {
        this.dataExcption = new DataExcption(other.dataExcption);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataExcption getDataExcption() {
      return this.dataExcption;
    }

    public savePerson_result setDataExcption(@org.apache.thrift.annotation.Nullable DataExcption dataExcption) {
      this.dataExcption = dataExcption;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXCPTION:
        if (value == null) {
          ...
          setDataExcption((DataExcption)value);
        }
        break;
    ...
    public int compareTo(savePerson_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataExcption()).compareTo(other.isSetDataExcption());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExcption()) {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // DATA_EXCPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExcption = new DataExcption();
