 ...
 */
public class NotLazySingle03 {
    private static NotLazySingle03 instance = new NotLazySingle03();
    private NotLazySingle03(){}
    public static NotLazySingle03 getInstance() {
        return instance;
    }
}
